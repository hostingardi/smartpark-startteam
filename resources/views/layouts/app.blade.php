                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('kasir.dashboard') }}" aria-expanded="false">
                                <i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span>
                            </a>
                        </li>
                        <li class="sidebar-title">Cashier Dashboard</li>
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('cashier.dashboard') }}" aria-expanded="false" title="Dashboard Kasir">
                        <i class="mdi mdi-cash-multiple"></i><span class="hide-menu">Dashboard Kasir</span>
                    </a>
                </li>
                <li class="sidebar-item">
